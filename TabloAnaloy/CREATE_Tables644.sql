...
/*
  OKP_sysStatistics :
	  ...
	  StatTable - хранилище стат. данных (STC_-таблицы)
	  Source - запрос стат. данных - это может быть вьюшка, функция или текст запроса (должен быть заключён в круглые скобки),
			   примечание: процедура в качестве источника не рассмативается т.к. скорость выполнения обновления стат. данных 
			   практически не будет зависеть от применения фильтра на источник (т.е. даже если надо обновить только одну запись 
			   процедура всё равно отработает все записи БД (вернув весь набор) и затратив на это большое количество времени)
	  ListField - имя поля, список значений которого передаётся в обработчик при вызове (используется для ограничения списка обрабатываемых записей)
...
EXEC sp_addextendedproperty 'MS_Description', N'СВЁРТКА количества изделий, представляющих собой комплект. 
  Указывается только для корневых партий (для ПП), остальные - 0.
  В базовых ЕИЗ', N'schema', N'dbo', N'table', N'ARH_CPL', N'column', N'FOLD_K'
...
EXEC sp_addextendedproperty 'MS_Description', N'Назначение размера партии
  0-по рассчету
  1-большее целое
  2-меньшее целое', N'schema', N'dbo', N'table', N'ARH_CPL', N'column', N'NRP'
...
EXEC sp_addextendedproperty 'MS_Description', N'тип потребности:
  0 - Основной
  1 - вспомогательный
  2 - заготовка
  3 - комплектующие
  4 - инструмент
  5 - унифицированное
  6 - основной материал по кооперации
  7 - вспомогательный материал по кооперации
  8 - заготовка по кооперации
  9 - покупное по кооперации', N'schema', N'dbo', N'table', N'ARH_POT', N'column', N'TM'
...
EXEC sp_addextendedproperty 'MS_Description', N'Коэффициент пересчёта количества (OKP_TRN.QTY) из ЕИЗ транзакции (OKP_TRN.EIZ_RASH) в 
базовую ЕИЗ (в соответствии с основной ЕИЗ) предмета', N'schema', N'dbo', N'table', N'ARH_TRNDOCData', N'column', N'CNT'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Имя текущей базовой ЕИЗ (в соответствии с текущей основной ЕИЗ) предмета - имя ЕИЗ, 
в которой указаны h_prc, h_qty', N'schema', N'dbo', N'table', N'ARH_TRNDOCData', N'column', N'H_EIZH'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Код состояния операции
'''' - активная запись
''2'' - активная, неподлежащая анулированию
''3'' - анулированная запись', N'schema', N'dbo', N'table', N'ARH_UOP', N'column', N'STS'
...
EXEC sp_addextendedproperty 'MS_Description', N'Дата начала операции; значение указывается 
на целочисленной шкале дат (см. функцию TWTime_IntAsDateTime)', N'schema', N'dbo', N'table', N'ARH_VOper', N'column', N'DB'
EXEC sp_addextendedproperty 'MS_Description', N'Дата окончания операции; значение указывается 
на целочисленной шкале дат (см. функцию TWTime_IntAsDateTime)', N'schema', N'dbo', N'table', N'ARH_VOper', N'column', N'DE'
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг записи:
0 - штрихкод сгенерирован автоматически
1 - штрихкод указан пользователем', N'schema', N'dbo', N'table', N'OKP_BARCODES', N'column', N'Met'
GO
...
N'Список визуальных наименований колонок в информационных записях. 
Используется при выдаче пользователю данных о заблокированных объектах - см. метод GetLockedInfoMethod. Значения в списке разделяются ";"', N'schema', N'dbo', N'table', N'OKP_sysObjects', N'column', N'LOCKEDINFOCOLUMNS'
EXEC sp_addextendedproperty 'MS_Description', 'ID базовой группы', 'schema', 'dbo', 'table', 'OKP_sysObjects', 'column', 'BaseGrp_ID'
EXEC sp_addextendedproperty 'MS_Description', 
N'Процедура сбора визуальных данных для выдачи пользователю информации о блокировке запрошенного объекта', 
N'schema', N'dbo', N'table', N'OKP_sysObjects', N'column', N'GetLockedInfoMethod'
EXEC sp_addextendedproperty 'MS_Description', 
N'Процедура выбирает заблокированные по связям объекты из списка (#LO_Locks) - см. процедуру sp_SelectLockedByList',  N'schema', N'dbo', N'table', N'OKP_sysObjects', N'column', N'SelectLockedMethod'
EXEC sp_addextendedproperty 'MS_Description', N'Процедура проверяет блокировку по связям объектов из списка (#LO_Locks) - см. процедуру sp_CheckLinkLocks', 
...
EXEC sp_addextendedproperty 'MS_Description', N'СВЁРТКА количества изделий, представляющих собой комплект. 
  Указывается только для корневых партий (для ПП), остальные - 0.
  В базовых ЕИЗ', N'schema', N'dbo', N'table', N'OKP_CPL', N'column', N'FOLD_K'
...
EXEC sp_addextendedproperty 'MS_Description', N'Назначение размера партии
  0-по рассчету
  1-большее целое
  2-меньшее целое', N'schema', N'dbo', N'table', N'OKP_CPL', N'column', N'NRP'
...
EXEC sp_addextendedproperty 'MS_Description', N'тип потребности:
  ...
  7 - вспомогательный материал по кооперации
  8 - заготовка по кооперации
  9 - покупное по кооперации', N'schema', N'dbo', N'table', N'OKP_POT', N'column', N'TM'
...
GO
EXEC sp_addextendedproperty 'MS_Description', N'тип КиМ:
  0 - Основной
  1 - вспомогательный
  2 - заготовка
  3 - комплектующие
...
EXEC sp_addextendedproperty 'MS_Description', N'Предельное отклонение даты учета от текущей даты, сут.', N'schema', N'dbo', N'table', N'OKP_SystemProperties', N'column', N'DeviationLimitDate'
EXEC sp_addextendedproperty 'MS_Description', N'Выдача партии по хронологии (параметр модуля "Склад"):
   0 - не учитывать партии, цена - средняя
   1 - FIFO - приоритет у ранней партии, цена = цене партии
   2 - LIFO - приоритет у последней партии, цена = цене партии', N'schema', N'dbo', N'table', N'OKP_SystemProperties', N'column', N'KIM_OutType'
...
EXEC sp_addextendedproperty 'MS_Description', N'Контроль кратности запуска при постановке в план:
   0 - не учитывать
   1 - количество при постановке в план должно быть кратно параметру "Кратность запуска"', N'schema', N'dbo', N'table', N'OKP_SystemProperties', N'column', N'QCYRATControll'
...
EXEC sp_addextendedproperty 'MS_Description', 
    N'Флаг разрешения изменения складской цены ТМЦ вручную (редактирование цены в бланке ТМЦ, редактирование цены в записях бланка документов)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Тип затрат при автоматической калькуляции: общий = 0, цеховой = 1', N'schema', N'dbo', N'table', N'OKP_SystemProperties', N'column', N'AutoTZ'
...
GO
EXEC sys.sp_addextendedproperty N'MS_Description', N'Тип записи
1 - Затраты на основные материалы для собственного производства
2 - Затраты на вспомогательные материалы для собственного производства
3 - Покупные затраты
4 - Затраты на материалы по кооперации
5 - Брак в производстве
7 - Прямые трудовые затраты
8 - Косвенные затраты
9 - Прямые трудовые затраты по кооперации
17 - Инструменты НЗП
18 - Инструменты НЗП без текущего периода
19 - Основные материалы НЗП 
22 - Основные материалы НЗП без текущего периода
23 - Вспомогательные материалы НЗП
24 - Вспомогательные материалы НЗП без текущего периода
25 - Материалы по кооперации НЗП
26 - Материалы по кооперации НЗП без текущего периода
27 - Покупные НЗП
28 - Покупные НЗП без текущего периода
29 - Основная зарплата собственого НЗП
30 - Основная зарплата собственого НЗП без текущего периода
31 - Oсновная зарплата по кооперации НЗП
32 - Oсновная зарплата по кооперации НЗП без текущего периода
33 - Затраты на инструменты', 'SCHEMA', N'dbo', 'TABLE', N'OKP_ZATR', 'COLUMN', N'TYPE'
GO 
...
'''' - активная запись
''2'' - активная, неподлежащая анулированию
''3'' - анулированная запись', N'schema', N'dbo', N'table', N'OKP_UOP', N'column', N'STS'
...
EXEC sp_addextendedproperty 'MS_Description', N'Параллельное размещение передаточных партий по РМ: 0-да 1-нет', N'schema', N'dbo', N'table', N'OKP_RUT', N'column', N'PlanType'
...
EXEC sp_addextendedproperty 'MS_Description', N'Разделение на производственные партии', N'schema', N'dbo', N'table', N'OKP_RUT', N'column', N'SPLITPARTIES'
...
EXEC sp_addextendedproperty 'MS_Description', N'Размеры предмета', 'schema', 'dbo', 'table', 'okp_eng', 'column', 'sizes'
...
EXEC sp_addextendedproperty 'MS_Description', 
N'Складская цена ТМЦ по документу (без учёта НДС). 
В документах "Приёмка поставки" в значение этого поля включена стоимость доставки.', 
N'schema', N'dbo', N'table', N'OKP_TRN', N'column', N'PRC'
EXEC sp_addextendedproperty 'MS_Description', 
N'Цена по документу. 
Для большинства документов склада (кроме "Приемка поставки") PRC = PRC_D.
В документах поставки, как правило, указывается НДС, а в цене учитывется его объём.
Так же в документах на поставку может отдельно указываться цена доставки.
Исходя из этого в системе принято следующее соотношение складской цены (PRC) и 
цены по документу (PRC_D):
  - если в качестве основания указан документ "Накладная поставки" модуля Снабжение, то
    PRC = OKP_RZP_TRN_DATA.PRC_RECALC
  - если документ-основание не указан и НДС учитывается, то в зависимости от флага OKP_TRN.NDS_Included:
      * 0 (НДС не включён в цену PRC_D) -> PRC = PRC_D
      * 1 (НДС включён в цену PRC_D) -> PRC = PRC_D / (1 + НДС)
  - если документ-основание не указан и НДС не учитывается, то PRC = PRC_D', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг записи. Отражает состояние записи в зависимости от значения поля TRN_TSO:
 - TRN_TSO = "IN" (транзакция инвентаризации)
   1) isNull(met, 0) <> 1 - ТМЦ снят с инвентаризации 
   2) 1 - ТМЦ поставлен на инвентаризацию 
 - TRN_TSO = "IR" (транзакция оформления заказа на выдачу в производство)
   1) 0 - партии нет (ничего выдавать не надо)
   2) isNull(met, 1) <> 0 - заказ активен
...
EXEC sp_addextendedproperty 'MS_Description', 
N'если запись является ведущей (с ней связаны записи других документов - "ведомые документы"), то поле содержит итоговое "закрытое" количество
  (суммированное количество по всем связанным записям ведомых документов) в системной ЕИЗ расхода предмета (см. описание OKP_INV.QTY)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'НДС включен в цену:
0 - Итоговая сумма складывается из суммы ТМЦ плюс НДС
1 - НДС не влияет на итоговую сумму
...
EXEC sp_addextendedproperty 'MS_Description', 
N'Свёртка статуса строки:
  - null, 0 - строка НЕ распределена
  - 1 - строка полностью распределена (всё её количество учтено документами распределения)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг статуса документа:
  0 - не утверждён - документ является "черновиком", т.е. он в системе "не существует" и не
                     оказывает вляния на её работу (за исключением подсистемы "Места хранения")
  10 - утверждён',
  'schema', 'dbo', 'table', 'OKP_TRNDOC', 'column', 'Status'
EXEC sp_addextendedproperty 'MS_Description', N'Модификатор документа:
  NULL или 0 - стандартный документ
  <> 0 - модифицированный документ ', 
  N'schema', N'dbo', N'table', N'OKP_TRNDOC', N'column', N'Mode'
EXEC sp_addextendedproperty 'MS_Description', N'Тип ведущего документа:
0 - ведущего документа нет
> 0 - см. OKP_sysObjects.ID
...
EXEC sp_addextendedproperty 'MS_Description', 
N'Шаблон адресов мест хранения. Структура:
  - разделитель блоков - char(1)
  - первый блок - служебный - две цифры:
    -- первая цифра - флаг иерархии:
     0 - первый значащий блок - старший (например, "СТЕЛЛАЖ-полка-ячейка")
     1 - первый значащий блок - младший (например, "ЯЧЕЙКА-полка-стеллаж") 
    -- вторая цифра - флаг добавления обозначения склада в полное обозначение места хранения (v_WPlaces.FullAddr):
     0 - не добавлять
     1 - добавлять в соответствии с иерархией (см. пред. флаг):
         0 - обозначение склада указывается первым блоком
         1 - обозначение склада указывается последним блоком
  - второй и последующие блоки - значащие:
    -- каждый блок состоит из 4-х подблоков (например, "Я::Ячейка:2"):
      1 - префикс
      2 - суффикс
      3 - имя блока
      4 - разрядность
  пример обозначения в соответствии с указанным выше шаблоном - "Я01" ', 
  'schema', 'dbo', 'table', 'OKP_WRH', 'column', 'WPTemplate'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Разделитель элементов адреса мест хранения. Если не указан, то "."', 
  'schema', 'dbo', 'table', 'OKP_WRH', 'column', 'WPSeparator'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Флаг использования подсистемы "Места хранения":
  0 - не использовать - статус "Утвержден" устанавливается автоматически при создании; подсистема 
                        "Места хранения" не доступна
  1 - справочно -       статус "Утвержден" устанавливается автоматически при создании; подсистема
                        "Места хранения" доступна
  2 - использовать -    статус "Утвержден" устанавливается автоматически для полностью распределённого 
                        документа; подсистема "Места хранения" доступна ',
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг "Склад дефектовки": 
0, null - не является складом дефектовки;
1 - является складом дефектовки.', N'schema', N'dbo', N'table', N'OKP_WRH', N'column', N'isForDefective'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Флаг использования документа-основания при приёмке поставки:
  - 2 - ПО ДОКУМЕНТАМ - документы типа "Приёмка поставки" могут быть созданы только на основании
      документов учёта поставки, проведённых в модуле "Снабжение"
  - 1 - БЕЗ ДОКУМЕНТОВ - документы типа "Приёмка поставки" могут быть созданы только если
      основание не задано
  - 0 - СМЕШАННЫЙ РЕЖИМ - документы типа "Приёмка поставки" могут быть созданы как с указанием
      основания, так и без него',
    'schema', 'dbo', 'table', 'OKP_WRH', 'column', 'RPType'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Флаг разрешения модификатора IM-документа (см. OKP_TRNDOC.Mode):
  0 - модификатор запрещён - только стандартный документ
  1 - модификатор разрешён - документ может быть создан после учёта в производстве (по факту), а не до (как стандартный)', 
  N'schema', N'dbo', N'table', N'OKP_WRH', N'column', N'IMType'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Настройки управления статусами документов', 
  N'schema', N'dbo', N'table', N'OKP_WRH', N'column', N'DocSTS'
GO

EXEC sp_addextendedproperty 'MS_Description', 
N'Флаг использования номера счёт-фактуры поставки:
  - 0 - НЕ ИСПОЛЬЗОВАТЬ - счёт-фактура не требуется; соответствующее поле в документе поставки не доступно 
  - 1 - СПРАВОЧНО - счёт-фактура не требуется; соответствующее поле в документе поставки доступно 
  - 2 - ИСПОЛЬЗОВАТЬ - в документах поставки счёт-фактура должна быть указана; соответствующее поле в документе поставки доступно', 
N'schema', N'dbo', N'table', N'OKP_WRH', N'column', N'SPLFacturType'
GO

EXEC sp_addextendedproperty 'MS_Description', 
N'Флаг использования номера внешней накладной поставки:
  - 0 - НЕ ИСПОЛЬЗОВАТЬ - внешняя накладная не требуется; соответствующее поле в документе поставки не доступно 
  - 1 - СПРАВОЧНО - внешняя накладная не требуется; соответствующее поле в документе поставки доступно 
  - 2 - ИСПОЛЬЗОВАТЬ - в документах поставки внешняя накладная должна быть указана; соответствующее поле в документе поставки доступно', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Текущее наличное количество. Количество указано в системной ЕИЗ расхода.
Например, UOMPEIZ = тонна (обычно для тонны системной является килограмм), тогда QTY указана в килограммах.
Примечание: системные ЕИЗ и коэффициенты их преобразования возвращает EV_SYSEIZ ', N'schema', N'dbo', N'table', N'OKP_INV', N'column', N'QTY'
...
EXEC sp_addextendedproperty 'MS_Description', N'Суммарная трудоёмкость (н/час)', N'schema', N'dbo', N'table', N'OKP_NOM', N'column', N'SUMTRO'
EXEC sp_addextendedproperty 'MS_Description', N'Суммарное межоперационное время (в часах)', N'schema', N'dbo', N'table', N'OKP_NOM', N'column', N'SUMMOV'
...
EXEC sp_addextendedproperty 'MS_Description', N'Суммарная трудоемкость сборки', N'schema', N'dbo', N'table', N'OKP_NOM', N'column', N'SUMBOM'
...
EXEC sp_addextendedproperty 'MS_Description', N'Суммарная технологическая трудоёмкость, н/час', N'schema', N'dbo', N'table', N'OKP_NOM', N'column', N'SUMBOM_TRO'
...
/*
** Definition for table OKP_STKCodes : 
*/
CREATE TABLE dbo.OKP_STKCodes (
  STKIDN int IDENTITY(1, 1) NOT NULL,
  STKNAME varchar(60) COLLATE DATABASE_DEFAULT NOT NULL,
  STKIDN_ int NULL,
  TYP int NULL,
  GRP_ID int NULL,
  COMM varchar(250) COLLATE DATABASE_DEFAULT NULL,
  CONSTRAINT PK_OKP_STKCodes PRIMARY KEY CLUSTERED (STKIDN)
)
GO

EXEC sp_addextendedproperty 'MS_Description', N'Статьи затрат', N'schema', N'dbo', N'table', N'OKP_STKCodes'
EXEC sp_addextendedproperty 'MS_Description', N'ID статьи затрат', N'schema', N'dbo', N'table', N'OKP_STKCodes', N'column', N'STKIDN'
EXEC sp_addextendedproperty 'MS_Description', N'Наименование', N'schema', N'dbo', N'table', N'OKP_STKCodes', N'column', N'STKName'
EXEC sp_addextendedproperty 'MS_Description', N'Код', N'schema', N'dbo', N'table', N'OKP_STKCodes', N'column', N'Stkidn_'
EXEC sp_addextendedproperty 'MS_Description', N'Тип заведения', N'schema', N'dbo', N'table', N'OKP_STKCodes', N'column', N'Typ'
EXEC sp_addextendedproperty 'MS_Description', N'ID группы', 'schema', 'dbo', 'table', 'OKP_STKCodes', 'column', 'GRP_ID'
EXEC sp_addextendedproperty 'MS_Description', N'Комментарий', 'schema', 'dbo', 'table', 'OKP_STKCodes', 'column', 'COMM'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Код состояния операции: '''' - активная запись, ''3'' - анулированная запись', N'schema', N'dbo', N'table', N'OKP_UBR', N'column', N'STS'
...
CREATE TABLE dbo.OKP_Order (
	Order_Count int NULL,
	tab varchar(50) COLLATE DATABASE_DEFAULT NULL,
	Polz varchar(100) COLLATE DATABASE_DEFAULT NULL,
	DEP_IDN varchar(10) COLLATE DATABASE_DEFAULT NULL,
	Met tinyint NULL,
	dte datetime NULL,
	prt$$$nom varchar(50) COLLATE DATABASE_DEFAULT NULL,
	nmp$$$nam varchar(100) COLLATE DATABASE_DEFAULT NULL,
...
EXEC sp_addextendedproperty 'MS_Description', N'Табельный номер исполнителя', N'schema', N'dbo', N'table', N'OKP_Order', N'column', N'TAB'
EXEC sp_addextendedproperty 'MS_Description', N'ФИО ответственного', N'schema', N'dbo', N'table', N'OKP_Order', N'column', N'POLZ'
...
EXEC sp_addextendedproperty 'MS_Description', N'Подразделение исполнителя', N'schema', N'dbo', N'table', N'OKP_ORDER', N'column', N'DEP_IDN'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Табельный номер', N'schema', N'dbo', N'table', N'OKP_OrderSum', N'column', N'tab'
...
EXEC sp_addextendedproperty 'MS_Description', N'Обозначение модуля: 
T - технолог 
A - админ 
P - плановик 
D - диспетчер 
...
M - руководитель 
E - Экономист 
C - UpdateStatuses (утилита на сервере) 
B - RecalcBalans (утилита на сервере) ', N'schema', N'dbo', N'table', N'OKP_BufLog', N'column', N'Modul'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Имя таблицы', N'schema', N'dbo', N'table', N'OKP_BufLog', N'column', N'TblName'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Протоколируемое действие: 
Update - обновление указанной таблицы 
Delete - удаление из указанной таблицы 
Insert - вставка в указанную таблицу ', N'schema', N'dbo', N'table', N'OKP_BufLog', N'column', N'Act'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Состояние циклограммы 
  0 - не расчитана 
  1 - расчитана ', N'schema', N'dbo', N'table', N'OKP_CGM', N'column', N'STATE'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг состояния: 
0 - запись входит в состав циклограммы
1 - запись исключена из состава и переведена в потребность
2 - запись исключена из состава и переведена в дубль
3 - запись исключена из состава', N'schema', N'dbo', N'table', N'OKP_CGMData', N'column', N'SHIFT'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Тип контакта:
 1 - телефон,
 2 - адрес,
...
EXEC sp_addextendedproperty 'MS_Description', N'SQL-комманда для получения пользовательского представления (IDN) строки справочника
  Например, 
    select UOMIDN+'' - ''+NAENAM from OKP_EIZ where RWC = [ID], где
  [ID] - параметр запроса,обозначающий уникальный идентификатор строки справочника
...
EXEC sys.sp_addextendedproperty 
  ...
  @value=N'Идентификатор редактора справочника (соответствует настройке редактора в исходном коде системы)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Тип контакта:
   ...
   5 - Skype 
   6 - Соц. сеть
   7 - Другое', N'schema', N'dbo', N'table', N'OKP_FIO_CONTACTS', N'column', N'TYP'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'ID родительской группы', N'schema', N'dbo', N'table', N'OKP_GROUPS', N'column', N'P_GROUPS_ID'
EXEC sp_addextendedproperty 'MS_Description', N'Наименование группы', N'schema', N'dbo', N'table', N'OKP_GROUPS', N'column', N'NAME'
EXEC sp_addextendedproperty 'MS_Description', N'Дополнительная информация - может представлять собой структуру в соответствии с правилами, принятыми в системе ОКП (см. описание функции OKPStruct)', N'schema', N'dbo', N'table', N'OKP_GROUPS', N'column', N'INFO'
EXEC sp_addextendedproperty 'MS_Description', N'ID системного объекта', N'schema', N'dbo', N'table', N'OKP_GROUPS', N'column', N'SYSOBJECTS_ID'
...
EXEC sp_addextendedproperty 'MS_Description', N'Текущий статус
0- сформирован
1- частично принят
2- полностью принят', N'schema', N'dbo', N'table', N'OKP_IPT_ELEM', N'column', N'STATE'
GO
...
E - Экономист
C - UpdateStatuses (утилита на сервере)
B - RecalcBalans (утилита на сервере)
I - Модуль импорта', N'schema', N'dbo', N'table', N'OKP_Logs', N'column', N'Modul'
EXEC sp_addextendedproperty 'MS_Description', N'Имя таблицы', N'schema', N'dbo', N'table', N'OKP_Logs', N'column', N'TblName'
EXEC sp_addextendedproperty 'MS_Description', N'Тип протоколируемого действия: 
Update - обновление указанной таблицы 
Delete - удаление из указанной таблицы 
Insert - вставка в указанную таблицу ', N'schema', N'dbo', N'table', N'OKP_Logs', N'column', N'Act'
...
EXEC sp_addextendedproperty 'MS_Description', N'Уникальный идентификатор сообщения. Формат состоит из двух частей: 
 <000-00> 
 1) группа сообщения (3 знака) 
 2) номер сообщения в группе (2 знака) 
Пример: 001-01', N'schema', N'dbo', N'table', N'OKP_Messages', N'column', N'IDN'
GO

EXEC sp_addextendedproperty 'MS_Description', 
N'
Основной текст сообщения. Применяется для вывода сообщения о наборе записей
с указанием данных (параметров), общих для всех записей, в тексте сообщения.
Параметр выделяется квадратными скобками и состоит из трех частей: 
 1) имя параметра (только из списка, представленного в поле PARAMS) 
 2) управляющий знак двоеточие (":") 
 3) флаг: 1 = в тексте указать только имя параметра 
          2 = в тексте указать только значение параметра 
          3 = в тексте указать и имя и значение параметра 
Пример: "первая часть сообщения [TMC:2] вторая часть сообщения [Nal:3]" 
', 
...
EXEC sp_addextendedproperty 'MS_Description', 
N'
Расширенный текст сообщения. Применяется для вывода сообщения о единичной
записи с указанием её ключевых данных (параметров) в тексте сообщения.
Параметр выделяется квадратными скобками и состоит из трех частей: 
 1) имя параметра (только из списка, представленного в поле PARAMS) 
 2) управляющий знак двоеточие (":") 
 3) флаг: 1 = в тексте указать только имя параметра 
...
EXEC sp_addextendedproperty 'MS_Description', N'Параметры сообщения. Параметры перечисляются через точку с запятой (";"). 
Каждый параметр состоит из трех частей разделяемых двоеточием (":"): 
 1) имя параметра 
 2) описание параметра 
 3) переключатель видимости параметра в общем списке (0 - не показывать; 1 - показывать)
Пример: TMC:Товарно-материальная ценность:0;Nal:В наличии:1', N'schema', N'dbo', N'table', N'OKP_Messages', N'column', N'PARAMS'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Текст рекомендаций по устранению ошибки', 
	'schema', 'dbo', 'table', 'OKP_Messages', 'column', 'Recommendation'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на раздел в справочнике', 
	'schema', 'dbo', 'table', 'OKP_Messages', 'column', 'HelpContext'
GO

--
-- Definition for table OKP_MFCFOLD : 
--

CREATE TABLE dbo.OKP_MFCFOLD (
  ID bigint IDENTITY(1, 1) NOT NULL,
  TRN_IR bigint NOT NULL,
  FOLD_O float NULL,
  FOLD_A float NULL,
  PRIMARY KEY CLUSTERED (ID)
)
...
EXEC sp_addextendedproperty 'MS_Description', N'СВЁРТКА по резервам', N'schema', N'dbo', N'table', N'OKP_MFCFOLD'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на транзакциию "IR" (okp_trn.trn_id)', N'schema', N'dbo', N'table', N'OKP_MFCFOLD', N'column', N'TRN_IR'
GO

EXEC sp_addextendedproperty 'MS_Description', N'СВЁРТКА выданного в производство количества по резервам. В ЕИЗ соответствующей транзакции "IR"', N'schema', N'dbo', N'table', N'OKP_MFCFOLD', N'column', N'FOLD_O'
GO

EXEC sp_addextendedproperty 'MS_Description', N'СВЁРТКА аннулированного резерва (снятого с резерва). В ЕИЗ соответствующей транзакции "IR"', N'schema', N'dbo', N'table', N'OKP_MFCFOLD', N'column', N'FOLD_A'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Тип ведущего документа.
Типы документов - см. OKP_SYSOBJECTS, например:
  1	(таблица OKP_NOM) - карточки "Общей номенклатуры"
  2	(таблица OKP_INV) - карточки "Складской номенклатуры"
  ...
  5	(таблица OKP_PPP) - документы "Плановых позиций"
  6	(таблица OKP_TRN) - документы "Журналов склада"
и т.д.', N'schema', N'dbo', N'table', N'OKP_OBJLINKS', N'column', N'M_Type'
GO

EXEC sp_addextendedproperty 'MS_Description', N'ID ведомого документа', N'schema', N'dbo', N'table', N'OKP_OBJLINKS', N'column', N'S_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Тип ведомого документа.
Типы документов - см. таблицу OKP_SYSOBJECTS, например:
  1	(таблица OKP_NOM) - карточки "Общей номенклатуры"
  2	(таблица OKP_INV) - карточки "Складской номенклатуры"
  ...
  5	(таблица OKP_PPP) - документы "Плановых позиций"
  6	(таблица OKP_TRN) - документы "Журналов склада"
и т.д.', N'schema', N'dbo', N'table', N'OKP_OBJLINKS', N'column', N'S_Type'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Флаг автоматически созданного документа:
  0 - ведомый создан отдельно
  1 - ведомый создан автоматически одновременно с ведущим', N'schema', N'dbo', N'table', N'OKP_OBJLINKS', N'column', N'isAuto'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Уровень связи:
  0 - связь построчная
  1 - связь по заголовкам', N'schema', N'dbo', N'table', N'OKP_OBJLINKS', N'column', N'LinkLevel'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Вид заказа:
1 - производственный заказ
2 - заказ на покупку
3 - заказ на кооперацию
', N'schema', N'dbo', N'table', N'OKP_PLO', N'column', N'VID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Тип заказа:
0 - обычный
1 - госзаказ', N'schema', N'dbo', N'table', N'OKP_PLO', N'column', N'TYP'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Приоритет документа "Заказ" - от 1 до 100. 
  1 -   высший
  100 - самый низкий', N'schema', N'dbo', N'table', N'OKP_PLO', N'column', N'PRI'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Статус заказа:
0 - неактивен (по заказу нет ни одной плановой позиции)
1 - в работе - хотя бы одна из плановых позиций заказа находятся в одном из следующих состояний (см. OKP_PPP.STS):
      0 - поставлена в план (не подтверждена)
      1 - подтверждена
      2 - в производстве
      5 - остановлена ("заморожена")
    и НЕ выполнено условие "просрочен" (см. ниже)
2 - просрочен - хотя бы одна из плановых позиций заказа находится в одном из следующих состояний (см. OKP_PPP.STS):
      6 - просрочена (не подтверждена)
      3 - в производстве и просрочена
3 - завершён - ВСЕ имеющиеся плановые позиции заказа находятся в одном из следующих состояний (см. OKP_PPP.STS):
      4 - завершена
      8 - сдана на склад
4 - в архиве - ВСЕ позиции заказа ПОЛНОСТЬЮ сданы в архив
Примечание:
   - на значение статуса заказа НЕ влияют записи БЕЗ плановых позиций (за исключением статуса 0)
...
EXEC sp_addextendedproperty 'MS_Description', N'Приоритет позиции заказа (приоритет постановки в план) - от 1 до 100. 
  1 -   высший
  100 - самый низкий', N'schema', N'dbo', N'table', N'OKP_PLOData', N'column', N'PRI'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Код сотояния позиции заказа:
  0 - принята (факт создания записи в БД)
  1 - подтверждена (может стать позицией в производственном плане)', N'schema', N'dbo', N'table', N'OKP_PLOData', N'column', N'STZ'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Размер периода прогноза. Код периода:
0 - год
1 - квартал
2 - месяц
3 - декада
4 - неделя
5 - день.', N'schema', N'dbo', N'table', N'OKP_PRZ', N'column', N'PRD'
GO
...
CREATE TABLE dbo.OKP_PUR (
	ID bigint IDENTITY(1, 1) NOT NULL,
	PUR_IDN varchar(10) COLLATE DATABASE_DEFAULT NULL,
	NOM_ID int NOT NULL,
...
EXEC sp_addextendedproperty 'MS_Description', N'Кем создана запись', N'schema', N'dbo', N'table', N'OKP_PUR', N'column', N'created_by'
EXEC sp_addextendedproperty 'MS_Description', N'Кем изменена запись', N'schema', N'dbo', N'table', N'OKP_PUR', N'column', N'edited_by'
EXEC sp_addextendedproperty 'MS_Description', N'Когда создана запись', N'schema', N'dbo', N'table', N'OKP_PUR', N'column', N'created_date'
EXEC sp_addextendedproperty 'MS_Description', N'Когда изменена запись', N'schema', N'dbo', N'table', N'OKP_PUR', N'column', N'edited_date'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Группа', 'SCHEMA', N'dbo', 'TABLE', N'OKP_PUR', 'COLUMN', N'GRP_ID'
GO
...
--
-- Definition for table OKP_ReportParameters : 
--
...
EXEC sp_addextendedproperty 'MS_Description', N'Тип заявки:
0 - обычная
1 - госзаказ', N'schema', N'dbo', N'table', N'OKP_REQ', N'column', N'TYP'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Приоритет документа "Заявка" - от 1 до 100. 
  1 -   высший
  100 - самый низкий', N'schema', N'dbo', N'table', N'OKP_REQ', N'column', N'PRI'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Код периода разбиения времени поставки (от DTE до DTE_L):
0 - год
1 - квартал
2 - месяц
3 - декада
4 - неделя
5 - день', N'schema', N'dbo', N'table', N'OKP_REQData', N'column', N'REG'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Код сотояния позиции заявки:
0 - принята (факт создания записи в БД)
1 - подтверждена (может стать позицией в заказе)', N'schema', N'dbo', N'table', N'OKP_REQData', N'column', N'STZ'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Приоритет позиции заявки (приоритет постановки в план) - от 1 до 100. 
  1 -   высший
  100 - самый низкий', N'schema', N'dbo', N'table', N'OKP_REQData', N'column', N'PRI'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Журнал заявок на поставку' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Код заявки' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД Идентификатор заявки' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'RZP_IDN'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД договора' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'CONTRACT_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Дата создания записи' , N'SCHEMA',N'dbo',N'TABLE',N'OKP_RZP',N'COLUMN',N'DTE_CRT'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Пользователь' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP',N'COLUMN',N'USR'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Статус заявки: 0 - не подтверждена, 1 - подтверждена, 2 - завершен' ,N'SCHEMA',N'dbo',N'TABLE',N'OKP_RZP',N'COLUMN',N'STS'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Дата заявки' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'DTE'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД поставщика' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'SUP_IDN'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Наименование поставщика' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'SUP_NAME'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Сумма доставки' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'SUM_DOST'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Дата доставки по плану' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'RZP_MAX_DTE_POST'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Дата доставки по факту' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'DTE_DELIV_FACT'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Заморожена: 0 - Разморожена; 1 - Заморожена' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'FROZEN'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентификатор поставщика ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'SUP_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентификатор грузополучателя ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'CONSIGNEE_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Внутреннее служебное поле ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'GUID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Тип транспорта' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'UPUTRS'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Начальная дата поставки по плану' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'RZP_MIN_DTE_POST'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Сумма по КиМ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'SUM_PUR'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Сумма всего' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'SUM_ALL'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентификатор причины завершения заявки вручную' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'CLOSE_REJECT_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Комментарий причины завершения заявки вручную' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'CLOSE_COMMENT'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Комментарий' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP', N'COLUMN',N'COMMENT'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентификатор' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Дата транзакции' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'DTE_RZP_TRN'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Номер транзакции' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'TRN_NUM'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Контрагент' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'ID_CTR'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Договора' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'ID_CONTRACT'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Грузоотправитель' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'ID_CTR_SHIPPER'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Грузополучатель' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'ID_CTR_CONSIGNEE'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Ответственный' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'RESPONSIBLE_USERNAME'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Входящий номер' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'INCOMING_NUMBER'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Входящая дата ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'INCOMING_DATE'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Примечание' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'DESCRIPTION'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Статус: 0 - не проведен; 1 - проведен' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'STS'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Записи помеченные на удаление (0 - не помечен, 1 - помечен) ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN', N'COLUMN',N'DELETED'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Транзакции учёта поставки (снабжения)' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Общая стоимость доставки', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN', 'COLUMN', N'TOTAL_DELIVERY_COST'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентиикатор валюты', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN', 'COLUMN', N'CURRENCY_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Учитывать НДС', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN', 'COLUMN', N'NDS'
EXEC sys.sp_addextendedproperty N'MS_Description', N'НДС включена в стоимость', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN', 'COLUMN', N'NDS_INCLUDED_IN_PRC'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентификатор' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД транзакция' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'ID_RZP_TRN'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД предмета поставки' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'ID_PUR'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД склад' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'ID_WRH'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ИД Состава заявки' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'ID_RZP_DATA'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Поставлено грузоперевозчиком' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'QTY'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Цена за ед' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'PRC'
EXEC sys.sp_addextendedproperty N'MS_Description', N'НДС в %' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'NDS'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Номер строки (для сортировки и упорядочивания строк)' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'ROW_NUM'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Краткое описание' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'DESCRIPTION'
EXEC sys.sp_addextendedproperty N'MS_Description', N'ссылка на OKP_NOM' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'NOM_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'НДС для вывода на экран/печать' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'NDS_NAM'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Количество принятого на складе' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'QTY_POSTAV'
EXEC sys.sp_addextendedproperty N'MS_Description', N'НДС включено в цену', N'schema', N'dbo', N'table', N'OKP_RZP_TRN_DATA', N'column', N'NDS_INCLUDED'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Дата принятия ' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'DTE_POSTAV'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Принято на сумму' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'SUM_POSTAV'
EXEC sys.sp_addextendedproperty N'MS_Description', N'НДС суммой' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'NDS_SUM'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Сумма с НДС' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'SUM_WITH_NDS'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Свёртка QTY_POSTAV' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'Fold_I'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Свёртка цены QTY_POSTAV' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'Fold_S'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Свёртка DTE_POSTAV' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA', N'COLUMN',N'Fold_D'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Состав транзакции снабжения' , N'SCHEMA',N'dbo', N'TABLE',N'OKP_RZP_TRN_DATA'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Стоимость доставки', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN_DATA', 'COLUMN', N'DELIVERY_COST'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Транзитная норма поставки из заявки', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN_DATA', 'COLUMN', N'TNP'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Стоимость доставки одной ТНП', 'SCHEMA', N'dbo', 'TABLE', N'OKP_RZP_TRN_DATA', 'COLUMN', N'TNP_DEL_COST'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Идентификатор валюты', N'schema', N'dbo', N'table', N'OKP_RZP_TRN_DATA', N'column', N'CURRENCY_ID'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Включить стоимость доставки в цену 0 - не включать, 1 - включить', N'schema', N'dbo', N'table', N'OKP_RZP_TRN_DATA', N'column', N'INCLUDE_DELIVERY_IN_PRICE'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Цена после пересчета', N'schema', N'dbo', N'table', N'OKP_RZP_TRN_DATA', N'column', N'PRC_RECALC'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Сумма после пересчета', N'schema', N'dbo', N'table', N'OKP_RZP_TRN_DATA', N'column', N'SUM_RECALC'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Курс валюты', N'SCHEMA' ,N'dbo', N'TABLE' ,N'OKP_RZP_TRN_DATA', N'COLUMN' ,N'CURRENCY_RATE'
EXEC sys.sp_addextendedproperty N'MS_Description', N'Cсылка на таблицу OKP_EXTNOM', N'SCHEMA' ,N'dbo', N'TABLE' ,N'OKP_RZP_TRN_DATA', N'COLUMN' ,N'EXTNOM_ID'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Оптовая цена для соответствующего количества.
Поле представляет собой структуру в соответствии с правилами, 
принятыми в системе ОКП (см. описание функции OKPStruct)', N'schema', N'dbo', N'table', N'OKP_SLS', N'column', N'PRC'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Количество резервирования в системной ЕИЗ (EV_SYSEIZ.SYSIDN), соответствующей ЕИЗ планирования 
  (OKP_NOM.UOM$$$EIZ) по обозначению номенклатурной позиции', N'schema', N'dbo', N'table', N'OKP_SReserv', N'column', N'QTY'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Флаг активного заказа:
 0 - заказ аннулирован
 1 - заказ активен', N'schema', N'dbo', N'table', N'OKP_SReserv', N'column', N'isActive'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Количество резервирования по ССЗ в системной ЕИЗ (EV_SYSEIZ.SYSIDN), соответствующей ЕИЗ планирования 
  (OKP_NOM.UOM$$$EIZ) по указанной номенклатурной позиции склада', N'schema', N'dbo', N'table', N'OKP_SDT_SReserv', N'column', N'QTY'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Группа', 'SCHEMA', N'dbo', 'TABLE', N'OKP_SUP', 'COLUMN', N'GRP_ID'
GO
...
Текст шаблона. В состав шаблона, в общем случае, входят следующие
  лексеммы (подлежат замене при обработке):
   - стандартные
       1) [d], [dd] -    подставляется номер дня
       2) [m], [mm] -    подставляется номер месяца
       3) [yy], [yyyy] - подставляется номер года
       4) [hh] -         подставляется номер часа
       5) [nn] -         подставляется номер минуты
       6) [ss] -         подставляется номер секунды
       7) [ms] -         подставляется номер милисекунды
       8) [0] -          подставляется значение счётчика -
                           если текстовое представление счётчика занимает меньше
                           позиций, то эти позиции ПЕРЕД ним заполняются нулями
       9) [9] -          подставляется значение счётчика -
                           если текстовое представление счётчика занимает меньше
                           позиций, то размер результирующего значения лексеммы
                           уменьшается
   - OKP-параметры (см. TOKPParameter) в квадратных скобках
   - пользовательские - любой текст в квадратных скобках
Кроме того, шаблон может содержать текст, лежащий за пределами
  квадратных скобок - такой текст замене не подлежит и подставляется
  в экземпляры при обработке как есть.
Пример:
  при Counter = 1, 
      Step = 10, 
      Prefix = '''', 
      Suffix = '''', 
      Format = "на [dd].[mm].[yy] [hh]:[mm]:[ss] счётчик равен [000] единиц"
  экземпляр шаблона равен
      "на 1.2.2013 17:2:57 счётчик равен 011 единиц"
...
EXEC sp_addextendedproperty 'MS_Description', 
N'Идентификатор ведущего блокировщика', 
N'schema', N'dbo', N'table', N'OKP_sysLocks', N'column', N'UID'
EXEC sp_addextendedproperty 'MS_Description', 
N'Идентификатор блокировщика', 
N'schema', N'dbo', N'table', N'OKP_sysLocks', N'column', N'SUID'
EXEC sp_addextendedproperty 'MS_Description', 
N'Тип заблокированного объекта (см. OKP_sysObjects.ID)', 
N'schema', N'dbo', N'table', N'OKP_sysLocks', N'column', N'ObjectID'
EXEC sp_addextendedproperty 'MS_Description', 
N'Идентификатор заблокированного объекта (в соответствии со значением поля OKP_sysObjects.PARAMETERS)', 
N'schema', N'dbo', N'table', N'OKP_sysLocks', N'column', N'IDN'
EXEC sp_addextendedproperty 'MS_Description', 
N'Идентификатор пользователя, от имени которого объект заблокирован (см. OKP_sysLogins.ID)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица списка присоединяемых расчётчиков 
''9CE20B99-D254-4C62-BC37-57CE93413CD2'' - встроенный. 
Внутри библиотеки может быть несколько рассчётчиков,
Допускается повторение пары FileName-FunctionName, 
...
EXEC sp_addextendedproperty 'MS_Description', N'Список активных дней недели (используется только если IntervalBase = час или день). 
 1 - понедельник,
 2 - вторник,
 ...
 7 - воскресенье,
 8 - вся неделя.
значения перечисляются через запятую.', N'schema', N'dbo', N'table', N'OKP_sysSchedules', N'column', N'ActiveWeekDays'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Активное [время]/[день месяца + время]/[день года + время]. 
  - при IntervalBase = час   - не имеет значение
  - при IntervalBase = день  - используется значение времени
  - при IntervalBase = месяц - используется значение дня + времени
  - при IntervalBase = год   - используется значение дня + месяца + времени', N'schema', N'dbo', N'table', N'OKP_sysSchedules', N'column', N'ActiveDay'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Интервал срабатывания. 
 1 - час,
 2 - день,
 3 - месяц,
 4 - год', N'schema', N'dbo', N'table', N'OKP_sysSchedules', N'column', N'IntervalBase'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Размер период срабатывания
  - при IntervalBase = час   - количество часов
  - при IntervalBase = день  - количество дней
  - при IntervalBase = месяц - количество месяцев
  - при IntervalBase = год   - количество лет', N'schema', N'dbo', N'table', N'OKP_sysSchedules', N'column', N'IntervalVal'
GO
...
1 - запись исключена из состава и переведена в потребность
2 - запись исключена из состава и переведена в дубль
3 - запись исключена из состава
4 - запись исключена из состава и выведена в отдельную ПП
5 - запись исключена из состава и является составной частью записи, выведенной в отдельную ПП', N'schema', N'dbo', N'table', N'OKP_TPCData', N'column', N'SHIFT'
GO
...
EXEC sp_addextendedproperty 'MS_Description', N'Состояние записи (имеет значение только для записей, у которых IDP is null)
  0 - не расчитан 
  1 - расчитан 
  2 - поставлен в план', N'schema', N'dbo', N'table', N'OKP_TPCData', N'column', N'STATE'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Ключ ведомой группы (OKP_TPCData.ITEM_ID)', N'SCHEMA', N'dbo', N'TABLE', N'OKP_TPCData', N'COLUMN', N'Slave_ITEM_ID'
go
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг "Шаблон по умолчанию". По умолчанию может быть только один.
Шаблоном по умолчанию может быть и утверждённый и неутверждённый шаблон.
0 - не является шаблоном по умолчанию, 1 - является шаблоном по умолчанию', N'schema', N'dbo', N'table', N'OKP_TPSample', N'column', N'isDefault'
GO
...
CREATE TABLE dbo.OKP_UPU (
  ...
  SUP_IDN varchar(10) COLLATE DATABASE_DEFAULT NOT NULL,
  PUR_IDN varchar(10) COLLATE DATABASE_DEFAULT NOT NULL,
...
EXEC sp_addextendedproperty 'MS_Description', N'Идентификатор предмета поставки', N'schema', N'dbo', N'table', N'OKP_UPU', N'column', N'PUR_IDN'
...
EXEC sp_addextendedproperty 'MS_Description', N'Дата начала изготовления объекта; значение указывается 
на целочисленной шкале дат (см. функцию TWTime_IntAsDateTime)', N'schema', N'dbo', N'table', N'OKP_VObj', N'column', N'DB'
EXEC sp_addextendedproperty 'MS_Description', N'Дата окончания изготовления объекта; значение указывается 
на целочисленной шкале дат (см. функцию TWTime_IntAsDateTime)', N'schema', N'dbo', N'table', N'OKP_VObj', N'column', N'DE'
...
EXEC sp_addextendedproperty 'MS_Description', N'Дата начала операции; значение указывается 
на целочисленной шкале дат (см. функцию TWTime_IntAsDateTime)', N'schema', N'dbo', N'table', N'OKP_VOper', N'column', N'DB'
EXEC sp_addextendedproperty 'MS_Description', N'Дата окончания операции; значение указывается 
на целочисленной шкале дат (см. функцию TWTime_IntAsDateTime)', N'schema', N'dbo', N'table', N'OKP_VOper', N'column', N'DE'
...
CREATE TABLE dbo.OKP_WRK_ACTIV (
	...
	МЕТ varchar(1) COLLATE DATABASE_DEFAULT NULL,
	wpl_id INT NULL,
...
EXEC sp_addextendedproperty 'MS_Description', N'Метка (служебное поле)', N'schema', N'dbo', N'table', N'OKP_WRK_ACTIV', N'column', N'МЕТ'
...
EXEC sp_addextendedproperty 'MS_Description', N'Код состояния записи:
1 - план поставок
2 - график отгрузки
3 - в задание на отгрузку', N'schema', N'dbo', N'table', N'OKP_ZPU', N'column', N'STS'
GO
...
CREATE TABLE ARH_SDT_ELEM (
  ...
  QTYCQY_SDT float,
  CAPACITY_PLAN float,
  COMMENT varchar(20) COLLATE DATABASE_DEFAULT 
)
GO
...
0- сформирован
1- частично принят
2- полностью принят', N'schema', N'dbo', N'table', N'ARH_IPT_ELEM', N'column', N'STATE'
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица складских мест хранения', 
	'schema', 'dbo', 'table', 'OKP_WPlaces'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Счётчик', 
'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на склад (OKP_WRH.WRH_ID)', 
	'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'WRH_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Обозначение места хранения', 
	'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'IDN'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Адрес места хранения', 
	'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'Addr'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Наименование', 
	'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'Name'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на родительское место хранения', 
	'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'IDP'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Флаг разрешения размещения: 0 - нет, 1 - да', 
	'schema', 'dbo', 'table', 'OKP_WPlaces', 'column', 'Enabled'
GO

EXEC sp_addextendedproperty 'MS_Description', 
	N'Флаг формирования полного обозначения места хранения:
	 0 - формируется свободно (особое место хранения)
	 1 - формируется в соответстви с шаблоном (см. OKP_WRH.WPTemplate)
	 Примечание:
	   "полное обозначение" - v_WPlaces.FullIDN', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица складских документов распределения по местам хранения', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на группу (OKP_GROUPS.ID)', 
	'schema', 'dbo', 'table', 'OKP_WPDocs', 'column', 'GRP_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Обозначение документа', 
'schema', 'dbo', 'table', 'OKP_WPDocs', 'column', 'DOC'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Тип документа 1 - распределение', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Дата документа', 
	'schema', 'dbo', 'table', 'OKP_WPDocs', 'column', 'DKD'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Владелец документа (тот, кто создал документ) - ссылка на OKP_USERS.User_ID', 
	'schema', 'dbo', 'table', 'OKP_WPDocs', 'column', 'Owner_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Описание документа', 
	'schema', 'dbo', 'table', 'OKP_WPDocs', 'column', 'DESCRIBE'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Дата создания документа (не меняется)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица содержимого документов распределения (OKP_WPDocs)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на документ (OKP_WPDocs.ID)', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'DOC_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Номер строки в документе', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'LIN'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на ТМЦ (OKP_INV.INV_ID)', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'INV_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на складскую карточку объекта (OKP_WRH_SUBJECTS.ID)', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'SUB_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на место-источник (OKP_WPlaces.ID)', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'WP_S_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на место-приёмник (OKP_WPlaces.ID)', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'WP_D_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Количество в ЕИЗ хранения из бланка ТМЦ (OKP_INV.UOMHEIZ)', 
	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'QTY'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на документ "Транзакция" (OKP_TRN.TRN_ID)', 
 	'schema', 'dbo', 'table', 'OKP_WPDocsData', 'column', 'TRN_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', 
N'Статус строки:
  - null, 0 - строка НЕ заблокирована
  - 1 - строка заблокирована в связи с тем, что ведущая запись (по ссылке OKP_TRN.TRN_ID) является полностью 
        распределенной строкой утверждённого документа оборота', 
  N'schema', N'dbo', N'table', N'OKP_WPDocsData', N'column', N'STS'
GO

EXEC sp_addextendedproperty 'MS_Description', 
N'Свёртка статуса (STS) строки (описание см. OKP_WPDocsData.STS)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица распределения ТМЦ по ячейкам', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на складскую карточку объектов (OKP_WRH_SUBJECTS.ID)', 
	'schema', 'dbo', 'table', 'OKP_WPInv', 'column', 'SUB_ID'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на ячейку (OKP_WPlaces.ID)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица стандартных мест хранения ТМЦ', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на ячейк (OKP_WPlaces.ID)', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Доп. номенклатура на технологической операции', N'schema', N'dbo', N'table', N'OKP_NOMRUTADD'
...
EXEC sp_addextendedproperty 'MS_Description', N'Таблица пользовательских колонок', 
...
EXEC sp_addextendedproperty 'MS_Description', 
	...
	4 - время
	5 - список
	6 - набор (несколько значений из списка)
	', 
	'schema', 'dbo', 'table', 'OKP_sysColumns', 'column', 'TYPE'
GO

EXEC sp_addextendedproperty 'MS_Description', 
	N'Список предопределённых значений. Значения разделяются символом char(1)', 
	'schema', 'dbo', 'table', 'OKP_sysColumns', 'column', 'LIST'
GO

EXEC sp_addextendedproperty 'MS_Description', N'Описание', 
...
GO
EXEC sp_addextendedproperty 'MS_Description', N'Таблица дополнительной технической информации о номенклатуре', 
  'schema', 'dbo', 'table', 'OKP_NOMTechInfo'
GO
EXEC sp_addextendedproperty 'MS_Description', N'счётчик', 
  'schema', 'dbo', 'table', 'OKP_NOMTechInfo', 'column', 'ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на номенклатуру (OKP_NOM.RWC)', 
  'schema', 'dbo', 'table', 'OKP_NOMTechInfo', 'column', 'NOM_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на пользовательский тип данных (OKP_sysColumns.ID)', 
  'schema', 'dbo', 'table', 'OKP_NOMTechInfo', 'column', 'Column_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'Значение характеристики', 
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'счётчик' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'OKP_GROUPColumns', @level2type=N'COLUMN',@level2name=N'ID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Ссылка на группу (OKP_GROUPS.ID)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'OKP_GROUPColumns', @level2type=N'COLUMN',@level2name=N'GROUP_ID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Ссылка на пользовательскую колонку (OKP_sysColumns.ID)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'OKP_GROUPColumns', @level2type=N'COLUMN',@level2name=N'Column_ID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Таблица соответствия пользовательских колонок группе объекта. Позволяет задать набор характеристик
  одновременно всем объектам, входящим в группу.
  Напрмер, если объект инструмент "fr000101" ввести в группу "Фрезы", которой сопоставлена колонка "Шифр", 
  то у этого инструмента автоматически появляется техническая характеристика "Шифр" ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'OKP_GROUPColumns'
GO
...
EXEC sys.sp_addextendedproperty 'MS_Description', 
	N'Вид объекта прав доступа: 
	0 - базовые из OKP_AccessType;
	1 - методы из OKP_ObjMethod;
	2 - подразделения из OKP_DEP;
	3 - аттрибуты из OKP_ObjAttr;
	4 - зарезервировано под админку;
	5 - модули из OKP_v_sysModules;
	6 - отчёты из OKP_Reports;
	7 - экспорта из OKP_DataExport;
	8 - функции из OKP_FUNCTION;
	9 - подразделения из OKP_DEP (временно);
	10 - мониторы из OKP_MON', 
...
GO
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на документ инвентаризации (OKP_TRNDoc.ID)',   
...
GO
EXEC sp_addextendedproperty 'MS_Description', N'Ссылка на место хранения (OKP_WPlaces.ID)',   
                            'schema', 'dbo', 'table', 'OKP_InventoryWP', 'column', 'WP_ID'
GO
EXEC sp_addextendedproperty 'MS_Description', N'Количество ДО инвентаризации.
Указано в ЕИЗ хранения из бланка ТМЦ (OKP_INV.UOMHEIZ)',   
                            'schema', 'dbo', 'table', 'OKP_InventoryWP', 'column', 'QTY_OLD'
GO
EXEC sp_addextendedproperty 'MS_Description', N'Количество ПОСЛЕ инвентаризации.
Указано в ЕИЗ хранения из бланка ТМЦ (OKP_INV.UOMHEIZ)',   
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг доступности в мониторах', N'schema', N'dbo', N'table', N'OKP_MSRC', N'column', N'inMonitor'
EXEC sp_addextendedproperty 'MS_Description', N'Флаг доступности в импорте', N'schema', N'dbo', N'table', N'OKP_MSRC', N'column', N'inImport'
...
EXEC sp_addextendedproperty 'MS_Description', N'Тип значения:
	COLUMN -> OKP_MON_MFLD.IDN, 
	TEXT -> простой текст,
	HIDDEN -> скрытое поле (системное),
	BIT -> логическое значение (да/нет)', N'schema', N'dbo', N'table', N'OKP_MDSET', N'column', N'TYPE'
...
EXEC sp_addextendedproperty 'MS_Description', N'Схема расчёта:
  1 - вперёд
  2 - назад
  3 - по циклограмме (SCHEME_ID - ссылка на циклограмму OKP_CGM.ID)
  4 - по шаблону (SCHEME_ID - ссылка на шаблон OKP_TPSampleQTY.ID)', 
...
EXEC sys.sp_addextendedproperty N'MS_Description','История сессий расчетов статусов обеспеченности КиМ','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_CALC_SESSIONS'
EXEC sys.sp_addextendedproperty N'MS_Description','Идентификатор','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_CALC_SESSIONS','COLUMN',N'ID'
EXEC sys.sp_addextendedproperty N'MS_Description','Дата время расчета','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_CALC_SESSIONS','COLUMN',N'DTE'
EXEC sys.sp_addextendedproperty N'MS_Description','Расчитано польщователем','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_CALC_SESSIONS','COLUMN',N'USR'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description','Исходные данные для расчета статуса обеспеченности КиМ','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_POT'
EXEC sys.sp_addextendedproperty N'MS_Description','Ссылка на запись в таблице OKP_POT','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_POT','COLUMN',N'RWC_POT'
EXEC sys.sp_addextendedproperty N'MS_Description','Объём дефицита','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_POT','COLUMN',N'QTY_DEFICIT'
EXEC sys.sp_addextendedproperty N'MS_Description','Резерв заказа, в днях','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_POT','COLUMN',N'DAY_RESERV'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description','Статусы обеспеченности КиМ','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS'
EXEC sys.sp_addextendedproperty N'MS_Description','ID','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS','COLUMN',N'id'
EXEC sys.sp_addextendedproperty N'MS_Description','ID системного объекта','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS','COLUMN',N'sysobj_id'
EXEC sys.sp_addextendedproperty N'MS_Description','ID объекта','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS','COLUMN',N'rwc'
EXEC sys.sp_addextendedproperty N'MS_Description','Статус по остаткам','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS','COLUMN',N'STS_WRH'
EXEC sys.sp_addextendedproperty N'MS_Description','Статус по заявкам','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS','COLUMN',N'STS_RZP'
EXEC sys.sp_addextendedproperty N'MS_Description','Статус по выданному','SCHEMA',N'dbo','TABLE',N'OKP_OBSP_STS','COLUMN',N'STS_IM'
GO
...
EXEC sys.sp_addextendedproperty N'MS_Description','Внешние наименования номенклатуры','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM'
EXEC sys.sp_addextendedproperty N'MS_Description','Внешнее обозначение','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'idn'
EXEC sys.sp_addextendedproperty N'MS_Description','Внешнее наименования','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'name'
EXEC sys.sp_addextendedproperty N'MS_Description','ID номенклатуры','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'nom_id'
EXEC sys.sp_addextendedproperty N'MS_Description','ID контрагента','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'ctr_id'
EXEC sys.sp_addextendedproperty N'MS_Description','ID ответственного','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'user_id'
EXEC sys.sp_addextendedproperty N'MS_Description','Дата создания','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'date_created'
EXEC sys.sp_addextendedproperty N'MS_Description','По умолчанию','SCHEMA',N'dbo','TABLE',N'OKP_EXTNOM','COLUMN',N'is_default'
GO
...
/*
** отскочить обратно к default-базе - нужно для инсталлятора
*/
use master
go
