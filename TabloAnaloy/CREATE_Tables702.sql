...
(OKP_NOM.UOM$$$EIZ) по обозначению номенклатурной позиции', N'schema', N'dbo', N'table', N'OKP_UNOM_REZERV', N'column', N'QTY'
...
EXEC sp_addextendedproperty 'MS_Description', N'Выдача партии по хронологии (параметр модуля "Склад"):
   ...
   2 - LIFO - приоритет у последней партии, цена = цене партии
   3 - FEFO - приоритет у партии, у которой раньше истекает срок годности', N'schema', N'dbo', N'table', N'OKP_SystemProperties', N'column', N'KIM_OutType'
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг документа "Выдача для производства по заказу", регулирующего разрешение на отпуск большего количества чем указано в документе резерва', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Флаг автораспределения серийных номеров и номерных партий при добавлении ТМЦ в документ', 
N'schema', N'dbo', N'table', N'OKP_WRH', N'column', N'AutoDistribObj'
EXEC sp_addextendedproperty 'MS_Description', 
N'Флаг документа "Приёмка от производства", регулирующего разрешение на приём партий с перерасходом:
  - ДА - разрешение включено (разрешено принимать партии с перерасходом)
  - НЕТ - разрешение выключено (принимать партии с перерасходом нельзя)', 
  N'schema', N'dbo', N'table', N'OKP_WRH', N'column', N'RMOverrunEnable'
EXEC sp_addextendedproperty 'MS_Description', 
N'Флаг документов выдачи в производство, регулирующий контроль срока годности: 
  - ДА - контроль включен, при выдаче осуществляется контроль остаточного срока годности
  - НЕТ - контроль отключен', 
...
EXEC sp_addextendedproperty 'MS_Description', N'Допустимый остаточный период годности. Значение указано в сутках. 
Определяет за сколько до окончания срока годности предприятие может использовать материал в производстве своей продукции.', N'schema', N'dbo', N'table', N'OKP_NOM', N'column', N'PermPeriod'
